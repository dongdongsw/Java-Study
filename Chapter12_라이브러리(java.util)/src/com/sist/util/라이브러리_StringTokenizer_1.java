 ...
 * 			ㄴ ★★★ArrayList , Vector, LinkedList, Queue
 * 							ㄴ 네트워크의 접속자 저장(동기)
 * 				ㄴ 데이터베이스 (비동기)
 * 
 ...
 * 			ㄴ ★★★HashSet, TreeSet
 * 
 * 		Map형 => 순서가 없다, (키, 값)쌍으로 되어있다
 * 			ㄴ ★★★HashMap, Hashtable
 * 
 * 	3) Data / Calendar : 날짜 관련
 * 		ㄴ StringTokenizer : 구분자별로 문자열을 나눠주는 역할
 * 			ㄴ 1) 생성자 => 구분
 * 			ㄴ 2) countTokens() : 분리한 단어의 개수
 * 			ㄴ 3) hasMoreTokents : 루프 사용시 ( 반복문 ) 
 * 					ㄴ 분리된 단어가 몇개인지 모르는 경우
 * 					ㄴ 갯수가 명확하지 않는 경우
 * 			ㄴ 4) 분리된 단어를 읽어올  때
 * 					ㄴ nextToken
 * 
